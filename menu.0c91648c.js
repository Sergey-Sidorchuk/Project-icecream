...
(function () {
  ...
  var mobileBtnHeroRef = document.querySelector("[data-hero-button]");
  var mobileMenuHeaderRef = document.querySelector("[data-header-button]");
  var mobileMenuPositioningRef = document.querySelector("[data-positioning]");
  menuBtnRef.addEventListener("click", function () {
    ...
    mobileMenuPositioningRef.classList.toggle("is-open");
  });
})();
